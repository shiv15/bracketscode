...
define(function (require, exports, module) {
    ...
    document.querySelector('#addBtn').click = () => {
        //CommandManager.execute("/7/projects/30/index.htm");
        //archive('/7/projects/30/', "30/", function(err){return err});
        archive("/7/projects/30/Untitled-2sf/", 'Untitled-2sf/', function (err) { return err});
     };
    function upload(blob) {
        
        var xhr = new XMLHttpRequest();
        xhr.open("POST", 'http://localhost:8001/zipfile', true);
        ...
        //formData.append('Blob', myFileInput.files[0], 'BLOB');
        xhr.send(blob); 
    ...
    /*
        ...
        ////var formData = new FormData();
        //formData.append("Blob", blob);
            fetch('http://localhost:8001/zipfile', {
              method: 'post',
              headers: {
    ...
    socket.on('connect', function (data) {
      ...
      socket.emit('my other event', blobOrFile);
    });
    */
